<template>
  <div class="top-container">
    <h1 class="bg-title">Other Schedules</h1>
    <div class="old">
      <span class="text">OtherSchedules</span>
    ...
    filteredPatients() {
      return this.patients.filter(patient => {
        return (
          ...
          (patient.date3 == this.selectedDate ||
          patient.date7 === this.selectedDate ||
          patient.date28 === this.selectedDate)
        );
      })
      .sort((a, b) => {
